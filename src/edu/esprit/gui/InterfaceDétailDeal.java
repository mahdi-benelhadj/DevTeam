 ...
 * @author olfa
 */
public class InterfaceDétailDeal extends javax.swing.JFrame {

    /**
     * Creates new form InterfaceDétailDeal
     */
    public InterfaceDétailDeal() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButtonReserver.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceDétailDeal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceDétailDeal().setVisible(true);
            }
        });
    }
