 ...
 * @author olfa
 */
public class InterfaceListeDeal extends javax.swing.JFrame {

    /**
     * Creates new form InterfaceListeDeal
     */
    public InterfaceListeDeal() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceListeDeal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceListeDeal().setVisible(true);
            }
        });
    }
